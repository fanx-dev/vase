...
fan.fan2d.Font.prototype.fontWidth = function(font, str)
{
  try
  {
    ...
    if (fan.fan2d.Font.fontCx == null)
    {
      fan.fan2d.Font.fontCx = document.createElement("canvas").getContext("2d");
    }
    fan.fan2d.Font.fontCx.font = fan.fan2d.GfxUtil.fontToCss(font);
    return Math.round(fan.fan2d.Font.fontCx.measureText(str).width);
  }
  catch (err)
  {
