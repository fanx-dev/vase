...
{
  return fan.fgfx2d.BufImage.$type;
}
...
fan.fgfxWtk.Image.prototype.m_graphics = null; //fgfx2d graphics context
...
fan.fgfxWtk.Image.prototype.graphics = function()
{
  ...
  if (!this.m_graphics)
  {
    ...
    var rect = new fan.fgfx2d.Rect.make(0,0, this.m_size.m_w, this.m_size.m_h);
