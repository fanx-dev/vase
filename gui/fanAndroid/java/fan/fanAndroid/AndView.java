...
class AndView extends View implements Window {
  fan.fanWt.View view;

  AndView(Context context, fan.fanWt.View view) {
    super(context);
    this.view = view;
  }
  ...
  @Override
  public void repaintLater(fan.fan2d.Rect dirty) {
    throw Err.make("todo");
  }

  @Override
  public void repaint(fan.fan2d.Rect dirty) {
    if (dirty == null) {
      this.invalidate();
      return;
    }
  ...
  public boolean onTouchEvent(MotionEvent event) {
    fan.fanWt.MotionEvent e = andToFan(event);

    fan.fanWt.InputEvent ce = fan.fanWt.InputEvent.make(InputEvent.touchEvent);
    if (e.isDown())
  ...
  static fan.fanWt.MotionEvent andToFan(MotionEvent event) {
    ...
    return fan.fanWt.MotionEvent.make(pointers);
  }
  ...
  private static MotionPointer getMotionPointer(final MotionEvent e, final int i) {
    return MotionPointer.make(new Func.Indirect1() {
      ...
      public Object call(Object obj) {
        ...
        it.pos = fan.fan2d.Point.make((int) e.getX(i), (int) e.getY(i));
