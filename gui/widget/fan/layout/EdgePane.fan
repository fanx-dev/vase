...
//////////////////////////////////////////////////////////////////////////
  ...
  override Size prefSize(Int hintsWidth := -1, Int hintsHeight := -1)
  {
    top    := pref(this.top)
  ...
  {
    return w == null || !w.visible ? Size.defVal : w.prefSize(-1)
  }
