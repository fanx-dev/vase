...
public class AwtUtil {
  ...
  static public Path2D toAwtPath(fan.fan2d.Path path) {
  ...
  static java.awt.AlphaComposite toAwtComposite(fan.fan2d.Composite com, float alpha) {
  	int rule = 0;
  	if (com == fan.fan2d.Composite.srcAtop) {
  		rule = java.awt.AlphaComposite.SRC_ATOP;
  	} else if (com == fan.fan2d.Composite.srcIn) {
  		rule = java.awt.AlphaComposite.SRC_IN;
  	} else if (com == fan.fan2d.Composite.srcOut) {
  		rule = java.awt.AlphaComposite.SRC_OUT;
  	} else if (com == fan.fan2d.Composite.dstAtop) {
  		rule = java.awt.AlphaComposite.DST_ATOP;
  	} else if (com == fan.fan2d.Composite.dstIn) {
  		rule = java.awt.AlphaComposite.DST_IN;
  	} else if (com == fan.fan2d.Composite.dstOut) {
  		rule = java.awt.AlphaComposite.DST_OUT;
  	} else if (com == fan.fan2d.Composite.dstOver) {
  		rule = java.awt.AlphaComposite.DST_OVER;
  	} else if (com == fan.fan2d.Composite.lighter) {
  		return null;
  	} else if (com == fan.fan2d.Composite.copy) {
  		rule = java.awt.AlphaComposite.SRC;
  	} else if (com == fan.fan2d.Composite.xor) {
  		rule = java.awt.AlphaComposite.XOR;
  	} else if (com == fan.fan2d.Composite.clear) {
