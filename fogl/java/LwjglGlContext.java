...
//////////////////////////////////////////////////////////////////////////
  ...
  public void bindTexture(GlEnum target, GlTexture texture)
  {
    if (texture != null)
...
//  public void bindTexture(GlEnum target, GlTexture texture){ glBindTexture((int)target.val, texture.peer.getValue()); }
...
//  public GlActiveInfo getActiveAttrib(GlProgram program, long index){    int i = glGetActiveAttrib(program.peer.getValue(), (int)index);    GlActiveInfo p = GlActiveInfo.make();    p.peer.setValue(i);    return p;  }
//  public GlActiveInfo getActiveUniform(GlProgram program, long index){    int i = glGetActiveUniform(program.peer.getValue(), (int)index);    GlActiveInfo p = GlActiveInfo.make();    p.peer.setValue(i);    return p;  }
//  public GlShader[] getAttachedShaders(GlProgram program){ return glGetAttachedShaders(program.peer.getValue()); }
...
//  public null getProgramParameter(GlProgram program, GlEnum pname){ return glGetProgramParameter(program.peer.getValue(), (int)pname.val); }
//  public String getProgramInfoLog(GlProgram program){ return glGetProgramInfoLog(program.peer.getValue()); }
...
//  public null getShaderParameter(GlShader shader, GlEnum pname){ return glGetShaderParameter(shader.peer.getValue(), (int)pname.val); }
//  public String getShaderInfoLog(GlShader shader){ return glGetShaderInfoLog(shader.peer.getValue()); }
//  public String getShaderSource(GlShader shader){ return glGetShaderSource(shader.peer.getValue()); }
//  public null getTexParameter(GlEnum target, GlEnum pname){ return glGetTexParameter((int)target.val, (int)pname.val); }
//  public null getUniform(GlProgram program, GlUniformLocation location){ return glGetUniform(program.peer.getValue(), location.peer.getValue()); }
...
//  public void uniform1fv(GlUniformLocation location, ArrayBuffer v){ glUniform1fv(location.peer.getValue(), v.peer.getValue()); }
//  public void uniform1fv(GlUniformLocation location, double[] v){ glUniform1fv(location.peer.getValue(), v); }
//  public void uniform1iv(GlUniformLocation location, ArrayBuffer v){ glUniform1iv(location.peer.getValue(), v.peer.getValue()); }
//  public void uniform1iv(GlUniformLocation location, long[] v){ glUniform1iv(location.peer.getValue(), v); }
//  public void uniform2fv(GlUniformLocation location, ArrayBuffer v){ glUniform2fv(location.peer.getValue(), v.peer.getValue()); }
//  public void uniform2fv(GlUniformLocation location, double[] v){ glUniform2fv(location.peer.getValue(), v); }
//  public void uniform2iv(GlUniformLocation location, ArrayBuffer v){ glUniform2iv(location.peer.getValue(), v.peer.getValue()); }
//  public void uniform2iv(GlUniformLocation location, long[] v){ glUniform2iv(location.peer.getValue(), v); }
//  public void uniform3fv(GlUniformLocation location, ArrayBuffer v){ glUniform3fv(location.peer.getValue(), v.peer.getValue()); }
//  public void uniform3fv(GlUniformLocation location, double[] v){ glUniform3fv(location.peer.getValue(), v); }
//  public void uniform3iv(GlUniformLocation location, ArrayBuffer v){ glUniform3iv(location.peer.getValue(), v.peer.getValue()); }
//  public void uniform3iv(GlUniformLocation location, long[] v){ glUniform3iv(location.peer.getValue(), v); }
//  public void uniform4fv(GlUniformLocation location, ArrayBuffer v){ glUniform4fv(location.peer.getValue(), v.peer.getValue()); }
//  public void uniform4fv(GlUniformLocation location, double[] v){ glUniform4fv(location.peer.getValue(), v); }
//  public void uniform4iv(GlUniformLocation location, ArrayBuffer v){ glUniform4iv(location.peer.getValue(), v.peer.getValue()); }
//  public void uniform4iv(GlUniformLocation location, long[] v){ glUniform4iv(location.peer.getValue(), v); }
//  public void uniformMatrix2fv(GlUniformLocation location, boolean transpose, ArrayBuffer value){ glUniformMatrix2fv(location.peer.getValue(), transpose, value.peer.getValue()); }
//  public void uniformMatrix2fv(GlUniformLocation location, boolean transpose, double[] value){ glUniformMatrix2fv(location.peer.getValue(), transpose, value); }
//  public void uniformMatrix3fv(GlUniformLocation location, boolean transpose, ArrayBuffer value){ glUniformMatrix3fv(location.peer.getValue(), transpose, value.peer.getValue()); }
//  public void uniformMatrix3fv(GlUniformLocation location, boolean transpose, double[] value){ glUniformMatrix3fv(location.peer.getValue(), transpose, value); }
//  public void uniformMatrix4fv(GlUniformLocation location, boolean transpose, ArrayBuffer value){ glUniformMatrix4fv(location.peer.getValue(), transpose, value.peer.getValue()); }
//  public void uniformMatrix4fv(GlUniformLocation location, boolean transpose, double[] value){ glUniformMatrix4fv(location.peer.getValue(), transpose, value); }
...
//////////////////////////////////////////////////////////////////////////
  ...
  public void attachShader(GlProgram program, GlShader shader){ glAttachShader(program.peer.getValue(), shader.peer.getValue()); }
  public void bindAttribLocation(GlProgram program, long index, String name){ glBindAttribLocation(program.peer.getValue(), (int)index, name); }
  public void bindBuffer(GlEnum target, GlBuffer buffer){ glBindBuffer((int)target.val, buffer.peer.getValue()); }
  public void bindFramebuffer(GlEnum target, GlFramebuffer framebuffer){ glBindFramebuffer((int)target.val, framebuffer.peer.getValue()); }
  public void bindRenderbuffer(GlEnum target, GlRenderbuffer renderbuffer){ glBindRenderbuffer((int)target.val, renderbuffer.peer.getValue()); }
  ...
  public void compileShader(GlShader shader){ glCompileShader(shader.peer.getValue()); }
  ...
  public GlBuffer createBuffer(){    int i = glCreateBuffer();    GlBuffer p = GlBuffer.make();    p.peer.setValue(i);    return p;  }
  public GlFramebuffer createFramebuffer(){    int i = glCreateFramebuffer();    GlFramebuffer p = GlFramebuffer.make();    p.peer.setValue(i);    return p;  }
  public GlProgram createProgram(){    int i = glCreateProgram();    GlProgram p = GlProgram.make();    p.peer.setValue(i);    return p;  }
  public GlRenderbuffer createRenderbuffer(){    int i = glCreateRenderbuffer();    GlRenderbuffer p = GlRenderbuffer.make();    p.peer.setValue(i);    return p;  }
  public GlShader createShader(GlEnum type){    int i = glCreateShader((int)type.val);    GlShader p = GlShader.make();    p.peer.setValue(i);    return p;  }
  public GlTexture createTexture(){    int i = glCreateTexture();    GlTexture p = GlTexture.make();    p.peer.setValue(i);    return p;  }
  public void cullFace(GlEnum mode){ glCullFace((int)mode.val); }
  public void deleteBuffer(GlBuffer buffer){ glDeleteBuffer(buffer.peer.getValue()); }
  public void deleteFramebuffer(GlFramebuffer framebuffer){ glDeleteFramebuffer(framebuffer.peer.getValue()); }
  public void deleteProgram(GlProgram program){ glDeleteProgram(program.peer.getValue()); }
  public void deleteRenderbuffer(GlRenderbuffer renderbuffer){ glDeleteRenderbuffer(renderbuffer.peer.getValue()); }
  public void deleteShader(GlShader shader){ glDeleteShader(shader.peer.getValue()); }
  public void deleteTexture(GlTexture texture){ glDeleteTexture(texture.peer.getValue()); }
  ...
  public void detachShader(GlProgram program, GlShader shader){ glDetachShader(program.peer.getValue(), shader.peer.getValue()); }
  ...
  public void framebufferRenderbuffer(GlEnum target, GlEnum attachment, GlEnum renderbuffertarget, GlRenderbuffer renderbuffer){ glFramebufferRenderbuffer((int)target.val, (int)attachment.val, (int)renderbuffertarget.val, renderbuffer.peer.getValue()); }
  public void framebufferTexture2D(GlEnum target, GlEnum attachment, GlEnum textarget, GlTexture texture, long level){ glFramebufferTexture2D((int)target.val, (int)attachment.val, (int)textarget.val, texture.peer.getValue(), (int)level); }
  ...
  public long getAttribLocation(GlProgram program, String name){ return glGetAttribLocation(program.peer.getValue(), name); }
  public GlUniformLocation getUniformLocation(GlProgram program, String name){    int i = glGetUniformLocation(program.peer.getValue(), name);    GlUniformLocation p = GlUniformLocation.make();    p.peer.setValue(i);    return p;  }
  public void hint(GlEnum target, GlEnum mode){ glHint((int)target.val, (int)mode.val); }
  public boolean isBuffer(GlBuffer buffer){ return glIsBuffer(buffer.peer.getValue()); }
  public boolean isEnabled(GlEnum cap){ return glIsEnabled((int)cap.val); }
  public boolean isFramebuffer(GlFramebuffer framebuffer){ return glIsFramebuffer(framebuffer.peer.getValue()); }
  public boolean isProgram(GlProgram program){ return glIsProgram(program.peer.getValue()); }
  public boolean isRenderbuffer(GlRenderbuffer renderbuffer){ return glIsRenderbuffer(renderbuffer.peer.getValue()); }
  public boolean isShader(GlShader shader){ return glIsShader(shader.peer.getValue()); }
  public boolean isTexture(GlTexture texture){ return glIsTexture(texture.peer.getValue()); }
  public void lineWidth(double width){ glLineWidth((float)width); }
  public void linkProgram(GlProgram program){ glLinkProgram(program.peer.getValue()); }
  ...
  public void shaderSource(GlShader shader, String source){ glShaderSource(shader.peer.getValue(), source); }
  ...
  public void uniform1f(GlUniformLocation location, double x){ glUniform1f(location.peer.getValue(), (float)x); }
  public void uniform1i(GlUniformLocation location, long x){ glUniform1i(location.peer.getValue(), (int)x); }
  public void uniform2f(GlUniformLocation location, double x, double y){ glUniform2f(location.peer.getValue(), (float)x, (float)y); }
  public void uniform2i(GlUniformLocation location, long x, long y){ glUniform2i(location.peer.getValue(), (int)x, (int)y); }
  public void uniform3f(GlUniformLocation location, double x, double y, double z){ glUniform3f(location.peer.getValue(), (float)x, (float)y, (float)z); }
  public void uniform3i(GlUniformLocation location, long x, long y, long z){ glUniform3i(location.peer.getValue(), (int)x, (int)y, (int)z); }
  public void uniform4f(GlUniformLocation location, double x, double y, double z, double w){ glUniform4f(location.peer.getValue(), (float)x, (float)y, (float)z, (float)w); }
  public void uniform4i(GlUniformLocation location, long x, long y, long z, long w){ glUniform4i(location.peer.getValue(), (int)x, (int)y, (int)z, (int)w); }
  public void useProgram(GlProgram program){ glUseProgram(program.peer.getValue()); }
  public void validateProgram(GlProgram program){ glValidateProgram(program.peer.getValue()); }
