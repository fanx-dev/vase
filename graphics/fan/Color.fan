...
//////////////////////////////////////////////////////////////////////////
  ...
  ** static utilit
  **
  static Int getA(Int argb) { argb.shiftr(24).and(0xff) }
  static Int getR(Int argb) { argb.shiftr(16).and(0xff) }
  static Int getG(Int argb) { argb.shiftr(8).and(0xff) }
  static Int getB(Int argb) { argb.and(0xff) }
