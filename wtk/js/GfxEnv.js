...
fan.fgfxWtk.GfxEnv = fan.sys.Obj.$extend(fan.fgfxGraphics.GfxEnv);
...
fan.fgfxWtk.GfxEnv.prototype.makeConstImage = function(uri)
{
  ...
  fan.fgfxWtk.GfxUtil.addEventListener(image, "load", function(){
    p.m_size = fan.fgfxGraphics.Size.make(image.width, image.height);
    p.m_isLoaded = true;
  });
...
{
  var font = new fan.fgfxGraphics.Font();
  func.call(font);
  return font;
}
