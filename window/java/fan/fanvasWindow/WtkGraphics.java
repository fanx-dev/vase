...
public class WtkGraphics implements Graphics {
  ...
  @Override
  public Graphics copyImage(fan.fanvasGraphics.Image img2, Rect src, Rect dest) {
  ...
  @Override
  public Graphics drawImage(fan.fanvasGraphics.Image img2, long x, long y) {
    BufferedImage img = null;
    if (img2 instanceof WtkImage) {
      img = ((WtkImage) img2).getImage();
    } else if (img2 instanceof WtkConstImage) {
  ...
  @Override
  public fan.fanvasGraphics.Composite composite() {
    return composite;
  }

  @Override
  public void composite(fan.fanvasGraphics.Composite com) {
